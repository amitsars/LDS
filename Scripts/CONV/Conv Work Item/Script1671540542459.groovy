...
WebUI.callTestCase(findTestCase('CONV/Scanning Rulebook CONV'), [:], FailureHandling.STOP_ON_FAILURE)
...
//Clicks for sorting id
WebUI.click(findTestObject('Object Repository/CONV Work Item/Work flow Item Id/Work flow Item Id'))
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/CONV Work Item/Work flow Item Id/Work flow Item Id'))
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/Page_Home-LISSIAFLOW/a_Show Details'))
sheet1.getRow(17).createCell(3).setCellValue("Pass");
}
catch(Exception E) {
	sheet1.getRow(17).createCell(3).setCellValue("Fail");
	file.close()
...
WebUI.click(findTestObject('Object Repository/CONV Work Item/Conv Work Item/button_Open eApp'))
WebUI.delay(20)
WebUI.enableSmartWait()
//WebUI.click(findTestObject('Object Repository/CONV Work Item/Conv Work Item/a_Enter Application Information'))

//WebUI.click(findTestObject('Object Repository/Page_Home-LISSIAFLOW/a_Enter Application Information'))

if (WebUI.verifyElementPresent(findTestObject('Object Repository/CONV Work Item/Conv Work Item/a_Enter Application Information'), 20)) {
	WebUI.click(findTestObject('Object Repository/CONV Work Item/Conv Work Item/a_Enter Application Information'))
	sheet1.getRow(18).createCell(3).setCellValue("Pass");


   } 
else {
	sheet.getRow(77).createCell(2).setCellValue("FAILED - Enter Application URL not found");
	sheet1.getRow(18).createCell(3).setCellValue("Fail");
   }
