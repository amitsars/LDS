...
WebUI.setText(findTestObject('Object Repository/Scanning/Page_Start Interview  Underwriting/SG_Input4'),
	SG_Input4)
...
WebUI.delay(5)
WebUI.switchToWindowTitle('View Interview | Underwriting')

WebUI.delay(5)
try {
def NewCONVPolicy = WebUI.getText(findTestObject('Object Repository/Scanning/GetinterviewDetails/Get Policy'))
sheet.getRow(8).createCell(1).setCellValue(NewCONVPolicy);
sheet1.getRow(15).createCell(3).setCellValue("Pass");
sheet1.getRow(16).createCell(3).setCellValue("Pass");
}
catch(Exception E) {
	sheet1.getRow(15).createCell(3).setCellValue("Fail");
	sheet1.getRow(16).createCell(3).setCellValue("Fail");
	file.close()
